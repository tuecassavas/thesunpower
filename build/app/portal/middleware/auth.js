...
const auth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!req.headers.authorization) {
            (0, context_1.responseError)(new logError_1.LogError(errorVars_1.ErrorVars.E007_NOT_PERMISSION, 'AUTHENTICATION'), req, res);
            return;
        }
        jsonwebtoken_1.default.verify(req.headers.authorization.split(' ')[1], (_a = process.env.SECRET_TOKEN) !== null && _a !== void 0 ? _a : '');
        return next();
    }
    catch (error) {
