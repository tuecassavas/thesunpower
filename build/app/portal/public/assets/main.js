...
document.querySelector('#formInputNumberElectric').addEventListener('click', loadInput);
...
document.querySelector('#typeOfElectric').addEventListener('click', loadOption);
// collapse when click 
...
document.querySelector('#btnCollapseDemand').addEventListener('click', collapseDemand);
document.querySelector('#btnCollapseHabit').addEventListener('click', collapseHabit);
