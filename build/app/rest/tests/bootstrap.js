...
const initDB = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all([
      instance.dropCollection(db_1.COLLECTION.USERS),
      instance.dropCollection(db_1.COLLECTION.TAGS),
      instance.dropCollection(db_1.COLLECTION.ADMIN),
    ]);
    yield Promise.all([
      (0, users_1.usersSeeding)(instance),
      (0, tags_1.tagsSeeding)(instance),
      (0, admin_1.adminSeeding)(instance),
    ]);
