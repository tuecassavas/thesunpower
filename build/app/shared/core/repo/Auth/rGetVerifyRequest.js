...
exports.rGetVerifyRequest = void 0;
const db_1 = require("../../../types/db");
const rGetVerifyRequest = (username) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verifyRequest = yield collection.findOne({ username });
    if (!verifyRequest) {
        return null;
    }
    return {
...
exports.rGetVerifyRequest = rGetVerifyRequest;
