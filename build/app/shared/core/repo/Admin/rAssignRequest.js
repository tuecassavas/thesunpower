...
exports.rAssignRequest = void 0;
const db_1 = require("../../../types/db");
const modal_1 = require("../../../types/modal");
const rAssignRequest = (requestId, assignTo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield collection.updateOne({ request_id: requestId }, {
        $set: { assign_to: assignTo, status: modal_1.REQUEST_STATE_STATUS.ASSIGN }
    });
});
exports.rAssignRequest = rAssignRequest;
